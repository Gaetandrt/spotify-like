...
grant delete on table "next_auth"."accounts" to "public";

grant insert on table "next_auth"."accounts" to "public";

grant select on table "next_auth"."accounts" to "public";

grant update on table "next_auth"."accounts" to "public";
...
grant delete on table "next_auth"."sessions" to "public";

grant insert on table "next_auth"."sessions" to "public";

grant select on table "next_auth"."sessions" to "public";

grant update on table "next_auth"."sessions" to "public";
...
grant delete on table "next_auth"."users" to "public";

grant insert on table "next_auth"."users" to "public";

grant select on table "next_auth"."users" to "public";

grant update on table "next_auth"."users" to "public";
...
grant delete on table "next_auth"."verification_tokens" to "public";

grant insert on table "next_auth"."verification_tokens" to "public";

grant select on table "next_auth"."verification_tokens" to "public";

grant update on table "next_auth"."verification_tokens" to "public";
