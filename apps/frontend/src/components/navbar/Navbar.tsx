...
const Navbar = ({ children: children }: NavbarProps) => {
  const linkClass =
    "flex items-center space-x-2 hover:bg-slate-400/20 hover:rounded-[8px] p-2";
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Main content */}
      <div className="ml-auto w-10/12 h-full overflow-auto mt-8 pl-14 pr-14 bg-[#0F0D13]">{children}</div>
      {/* Left bar */}
